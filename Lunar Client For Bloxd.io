...
// @version      1.1
// @description Lunar Client for bloxd.io
// @author       WraithMC
// @match        https://bloxd.io/
// @match        https://bloxd.io/?utm_source=pwa
// @match        https://staging.bloxd.io/
// @icon         https://cdn2.steamgriddb.com/logo/ee4e30bee2b01d96b1574bcd6668f96f.png
// @license      MIT
// @grant        none
// ==/UserScript==
 
(function() {
    //copyright Lunar Client
    'use strict';
    ...
    function fast_refresh() {
                        document.title = "Bloxd.io - Lunar Client";
        ...
        if (background) {
            background.style.backgroundImage = 'url(https://cdn2.steamgriddb.com/grid/e180f801740362a17ff0a182cd2d7f51.png)';
        }
...
mainMenu.appendChild(DSLogo);
    ...
    MenuText.textContent = 'Lunar CLIENT';
...
<label style="margin-bottom: 10px; font-weight: 700;">TOGGLE KEY</label>
        ...
        <div style="display: flex; flex-direction: column; align-items: center; width: 385px; height: 185px; background: rgb(50, 50, 50); border: 2px solid rgb(60, 60, 60); border-radius: 10px; margin-top: 5px;">
        <label style=" font-size: 15px; margin-bottom: 10px; font-weight: 700;" >Lunar Client CONTROLS</label>
...
document.getElementById('colorPicker2').addEventListener('input', function() {
    ...
    document.querySelectorAll(".item").forEach(hotbar => {
     ...
     window.open('https://greasyfork.org/en/scripts/518606-lunar-client?fbclid=IwY2xjawGu5PpleHRuA2FlbQIxMQABHf3jzb5quQ4rXJrZuX2H1M1EyKGQOMIxvNLl5as50YNDc-iyqcZmZ7ZMtg_aem_zxoL5HKNM0dQ2QIYkmI6og', '_blank');
})
